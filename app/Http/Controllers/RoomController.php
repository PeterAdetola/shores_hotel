...
class RoomController extends Controller
{
    ...
    /**
     * Display all rooms for filtering.
     */
//    public function getlodged()
//    {
//        $categories = Category::all(); // For filter buttons
//        $rooms = Room::with('category')->get(); // Public display
//
//        return view('getlodged', compact('categories', 'rooms'));
//    }
//    public function filter(Request $request)
//    {
//        $type = $request->get('type'); // "room" or "apartment"
//
...
//        dd($rooms->toArray());
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Correct notification call - added false for $isAjax parameter
            return notification(
                'Room created successfully.',
                'success',
                false, // $isAjax parameter
                ['room_id' => $room->id] // Optional additional data
            );
            ...
            return notification(
                ...
                'error',
                false, // $isAjax parameter
                ['exception' => $e->getTraceAsString()] // Optional debug info
            );
        }
    }
