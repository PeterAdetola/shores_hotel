...
<div class="mil-content-sm-pad mil-p-100-100 mb-5">
    <div class="container">
        <div class="mil-text-center">
            <div class="mil-suptitle mil-mb-20 mil-fade-up">Confirmation</div>
            <h2 class="mil-mb-100 mil-fade-up">Confirm your Reservation</h2>
        </div>
        ...
        <div class="mil-modal-form">
            <form>
                ...
                <div class="mil-field-frame mil-mb-20">
                    ...
                    <input type="tel" placeholder="Enter WhatsApp number" autocomplete="tel">
