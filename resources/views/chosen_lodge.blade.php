...
<div class="mil-info">
    ...
    <img src="img/shapes/4.png" class="mil-shape mil-fade-up" style="width: 85%; bottom: -20%; right: -30%; transform: rotate(-30deg) scaleX(-1);" alt="shape">
    <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mil-image-frame">
                                    <img src="img/rooms/1.1.jpg" alt="room" data-swiper-parallax="0" data-swiper-parallax-scale="1.2">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mil-image-frame">
                                    <img src="img/rooms/1.2.jpg" alt="room" data-swiper-parallax="0" data-swiper-parallax-scale="1.2">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mil-image-frame">
                                    <img src="img/rooms/1.3.jpg" alt="room" data-swiper-parallax="0" data-swiper-parallax-scale="1.2">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mil-image-frame">
                                    <img src="img/rooms/2.1.jpg" alt="room" data-swiper-parallax="0" data-swiper-parallax-scale="1.2">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mil-image-frame">
                                    <img src="img/rooms/2.2.jpg" alt="room" data-swiper-parallax="0" data-swiper-parallax-scale="1.2">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4" data-sticky-container>
                ...
                <div class="mil-sticky mil-stycky-right mil-p-0-100" data-margin-top="140">
                    ...
                    <div class="mil-price-frame mil-mb-20">
                        <div class="mil-price"><span class="mil-symbol">NGN</span><span class="mil-number">100,000</span>/per night</div>
                    </div>
