...
@section('admin')
    ...
    @section('vendor_styles')
        <link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/vendors/materialize-stepper/materialize-stepper.min.css') }}">
    ...
    @section('styles')
        ...
        @include('admin.room.form_stepper_style')
    @endsection
    <!-- BEGIN: Page Main-->
    <div id="main">
        <div class="row">
