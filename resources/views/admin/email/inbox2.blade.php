...
@section('admin')
    ...
    <div id="main">
        <div class="row">
                                    ...
                                    <div class="sidebar-details">
                                        ...
                                        <div class="row valign-wrapper mt-10 pt-2 animate fadeLeft">
                                            <div class="col s3 media-image">
                                                <img src="{{ asset('admin/assets/images/user/2.jpg') }}" alt="" class="circle z-depth-2 responsive-img">
                ...
                <i class="material-icons delete-mails">delete</i>
                                        ...
                                        <div class="collection email-collection">
                                            <div class="email-brief-info collection-item animate fadeUp delay-1">
                                                ...
                                                <a class="list-content" href="{{ route('show') }}">
                        ...
                        fiber_manual_record </i>Note</span>
                                            ...
                                            <div class="email-brief-info collection-item animate fadeUp">
                                                ...
                                                <a class="list-content" href="{{ route('show') }}">
                                                    <div class="list-title-area">
                                                        <div class="user-media">
                                                            <img src="{{ asset('admin/assets/images/user/6.jpg') }}" alt=""
                                                                 class="circle z-depth-2 responsive-img avtar">
                                            ...
                                            <ul class="widget-timeline mb-0">
                                                ...
                                                <li class="timeline-items timeline-icon-red active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <img src="{{ asset('admin/assets/images/icon/pdf.png') }}" alt="document" height="30" width="25"
          ...
          <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('admin/assets/images/avatar/avatar-7.png') }}"
                                                                   alt="avatar" />
          </span>
