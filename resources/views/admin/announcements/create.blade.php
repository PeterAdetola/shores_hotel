            ...
            <div class="col s12">
                <div class="container">
                    <div class="section mb-5">
                        ...
                        <form id="formValidate0" method="POST" action="{{ route('announcement.store') }}">
                            @csrf
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input class="validate" required id="title" name="title" type="text" value="{{ old('title') }}" placeholder="2 - 5 word">
                                                    <label for="title">Title *</label>
                                                </div>
                                                <div class="input-field col s12">
                                                    <input id="subtitle" name="subtitle" type="text" value="{{ old('subtitle') }}" placeholder="2 - 5 word">
                            ...
                            <!-- Editor - EXACT STRUCTURE FROM WORKING TEST -->
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12 m6">
                                                    <input required id="cta_text" name="cta_text" type="text" value="{{ old('cta_text', 'Book Now') }}">
                                                ...
                                                <div class="col s12 m6">
                                                    ...
                                                    <select class="browser-default" id="cta_link" name="cta_link" required>
                                                        ...
                                                        <option value="{{ route('getRooms') }}">Rooms Page</option>
                                                        <option value="{{ route('home') }}">Home Page</option>
                                                        <option value="custom">Custom URL</option>
                                                    </select>
                                                </div>
                                                <div class="input-field col s12" id="customUrlContainer" style="display: none;">
                                                    <input id="custom_cta_link" type="url" placeholder="https://example.com">
                                                    <label for="custom_cta_link">Custom URL</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col s12 m6">
                                                    ...
                                                    <div style="display: flex; align-items: center; margin-top: 10px;">
                                                        <input type="color" id="border_color" name="border_color" value="{{ old('border_color', '#ff1493') }}" style="width: 60px; height: 40px;">
                                                        <input type="text" id="border_color_text" value="{{ old('border_color', '#ff1493') }}" style="margin-left: 10px; width: 120px; padding: 5px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        // Check what form-editor.js created
        setTimeout(function() {
            console.log('1. Checking snow-container:', document.getElementById('snow-container'));
            console.log('2. Checking editor div:', document.querySelector('#snow-container .editor'));
            console.log('3. Checking toolbar div:', document.querySelector('#snow-container .quill-toolbar'));
            console.log('4. Checking for Quill instance:', document.querySelector('#snow-container .editor').__quill);
            console.log('5. Checking .ql-toolbar class:', document.querySelector('.ql-toolbar'));
            console.log('6. Checking all buttons:', document.querySelectorAll('.ql-bold, .ql-italic, .ql-underline'));

            // Check if buttons are disabled
            var boldBtn = document.querySelector('.ql-bold');
            if (boldBtn) {
                console.log('7. Bold button HTML:', boldBtn.outerHTML);
                console.log('8. Bold button disabled?:', boldBtn.disabled);
                console.log('9. Bold button class list:', boldBtn.classList);
                console.log('10. Bold button parent:', boldBtn.parentElement);
            }

            // Try to get the Quill instance
            var editor = document.querySelector('#snow-container .editor');
            if (editor && editor.__quill) {
                console.log('11. ✅ Quill instance found!');
                console.log('12. Quill enabled?:', editor.__quill.isEnabled());
                console.log('13. Quill modules:', editor.__quill.getModule('toolbar'));

                // Try to enable it
                editor.__quill.enable(true);
                console.log('14. Tried to enable Quill');
            } else {
                console.log('11. ❌ No Quill instance found on editor element');
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() {
                ...
                if (editorEl && editorEl.__quill) {
                    ...
                    // FORCE ENABLE
                    editor.enable(true);
                    console.log('FORCED EDITOR TO ENABLE');
