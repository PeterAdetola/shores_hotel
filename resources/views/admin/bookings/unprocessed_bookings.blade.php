...
@section('admin')
    @section('styles')
        <link rel="stylesheet" type="text/css"
              href="{{ asset('admin/assets/vendors/data-tables/css/jquery.dataTables.min.css') }}">
        <link rel="stylesheet" type="text/css"
              href="{{ asset('admin/assets/vendors/data-tables/extensions/responsive/css/responsive.dataTables.min.css') }}">
    ...
    @endsection
    @php
        $pageTitle = 'Unprocessed Bookings';
    @endphp
                                                ...
                                                <table id="data-table-row-grouping" class="display">
                                                    ...
                                                    @foreach($bookings as $booking)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#confirm_booking-modal{{ $booking->id }}"
                                                                   class="modal-trigger gradient-45deg-indigo-blue mb-1 chip waves-effect waves-light accent-2 white-text">
                                                                    confirm
                                                                </a>
                                                                &nbsp;&nbsp;
                                                                <a href="#decline_booking{{ $booking->id }}"
                                                                   class="modal-trigger gradient-45deg-deep-orange-orange mb-1 chip waves-effect waves-light accent-2 white-text">
                                                                    cancel
                                                                </a>
                                                            </td>
                                                        </tr>
...
@section('vendor_scripts')
    ...
    <script
        src="{{ asset('admin/assets/vendors/data-tables/extensions/responsive/js/dataTables.responsive.min.js') }}"></script>
