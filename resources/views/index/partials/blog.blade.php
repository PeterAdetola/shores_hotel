<div class="mil-rooms mil-p-100-100">
    <img src="{{ asset('img/shapes/4.png') }}" class="mil-shape" style="width: 85%; top: -20%; right: -30%; transform: rotate(-30deg) scaleX(-1);" alt="shape">
    <div class="container">
            ...
            <div class="col-xl-4">
                ...
                <a href="publication.html" class="mil-card mil-mb-40-adapt mil-fade-up">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="{{ asset('img/blog/1.jpg') }}" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="mil-parameters">
                        <li>
                            <div class="mil-icon">
                                <img src="{{ asset('img/faces/6.jpg') }}" alt="author">
                            </div>
                            <div>Paul T.</div>
                        </li>
                        <li>
                ...
                <a href="publication.html" class="mil-card mil-mb-40-adapt mil-fade-up">
                    <div class="swiper-container mil-card-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="{{ asset('img/blog/2.jpg') }}" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                        </div>
                        <div class="mil-card-nav">
                ...
                <a href="publication.html" class="mil-card mil-mb-40-adapt mil-fade-up">
                    <div class="swiper-container mil-card-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mil-card-cover">
                                    <img src="{{ asset('img/blog/3.jpg') }}" alt="cover" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1">
                                </div>
                            </div>
                        </div>
                        <div class="mil-card-nav">
