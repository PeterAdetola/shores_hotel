                ...
                <div class="col-xl-6">
                    ...
                    <div class="mil-banner-content-frame">
                        <div class="mil-banner-content mil-text-center">
                            <h1 class="mil-mb-40">Choose the Apartment <br>of your dreams</h1>
                            <div class="mil-suptitle mil-breadcrumbs">
                                <ul>
                                    <li><a href="{{ url('/')  }}">Home</a></li>
                                    <li><a href="search.html">Our Apartments</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row allign-items-center mil-mb-100">
                <div class="col-xl-5">
                    ...
                    <h2 class="mil-row-title mil-fade-up grey-text">Our Apartments<span class="mil-badge">8</span></h2>
